...
{
    /// <inheritdoc />
    public partial class initialmigrationanddataseedingfordifficultiesandregions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("88d15133-0878-4a46-8a38-bfa37d4aeb34"), "Easy" },
                    { new Guid("88d15133-0878-4a46-8a38-bfa37d4aeb35"), "Medium" },
                    { new Guid("88d15133-0878-4a46-8a38-bfa37d4aeb36"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulty",
                keyColumn: "Id",
                keyValue: new Guid("88d15133-0878-4a46-8a38-bfa37d4aeb34"));

            migrationBuilder.DeleteData(
                table: "Difficulty",
                keyColumn: "Id",
                keyValue: new Guid("88d15133-0878-4a46-8a38-bfa37d4aeb35"));

            migrationBuilder.DeleteData(
                table: "Difficulty",
                keyColumn: "Id",
                keyValue: new Guid("88d15133-0878-4a46-8a38-bfa37d4aeb36"));
